		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			...
			<fo:page-sequence master-reference="A4-portrait">
				<fo:flow flow-name="xsl-region-body">
			  		...
			  		<fo:table width="100%"  >
							...
							<fo:table-body>
								<fo:table-row>
									<fo:table-cell>
									<fo:block>
									<fo:table width="100%"  border-color="#777777" border-bottom-width="1pt" border-bottom-style="solid">
										...
										<fo:table-body>
											<fo:table-row>
												<fo:table-cell>
													<fo:block>
														<fo:external-graphic src="url('pdfheader/MoneyGram_Logo.png')" content-height="scale-to-fit" height="0.55in"  content-width="1.3in" scaling="non-uniform"/>
													</fo:block>
												</fo:table-cell>
											...
											<fo:table-body>
												<fo:table-row>
													<fo:table-cell height="1.5cm">
														...
														<xsl:if test="./payment/cardHolderName">
															<xsl:if test="./payment/cardHolderName!=''">
																<fo:block>&#160;</fo:block>
																...
																<fo:block font-family="Arial" font-size="9pt" font-weight="normal">
																	<xsl:value-of select="./payment/cardHolderAddress"/>
																</fo:block>
																<fo:block>&#160;</fo:block>
															</xsl:if>
														</xsl:if>
									...
									<fo:block font-size="10pt" font-weight="bold" font-family="sans-serif" color="#E0E0E0">
									</fo:block>
									</fo:table-cell>
									<fo:table-cell>
									<fo:block font-size="8pt" font-weight="bold" font-family="sans-serif" line-height="11pt" space-after.optimum="2pt" background-color="#A60000" color="white" text-align="left" padding-top="1pt">
										PRO-FORMA INVOICE
									</fo:block>
									<fo:block background-color="WhiteSmoke">
										...
										<fo:table-body>
											<fo:table-row>
												<fo:table-cell height="0.5cm" border-color="#CC0000" border-bottom-width="0.5pt" border-bottom-style="solid"><fo:block></fo:block></fo:table-cell>
												<fo:table-cell height="0.5cm" border-color="#CC0000" border-bottom-width="0.5pt" border-bottom-style="solid"><fo:block></fo:block></fo:table-cell>
												<fo:table-cell height="0.5cm" border-color="#CC0000" border-bottom-width="0.5pt" border-bottom-style="solid"><fo:block></fo:block></fo:table-cell>
												<fo:table-cell height="0.5cm" border-color="#CC0000" border-bottom-width="0.5pt" border-bottom-style="solid"><fo:block></fo:block></fo:table-cell>
											</fo:table-row>
											...
											<fo:table-row>
												<fo:table-cell><fo:block></fo:block></fo:table-cell>
												<fo:table-cell text-align="left" height="0.4cm">
													<fo:block font-family="Arial" font-size="9pt" font-weight="normal">Agency Locator</fo:block>
												</fo:table-cell>
												<fo:table-cell text-align="right" height="0.4cm">
													<fo:block font-family="Arial" font-size="9pt" font-weight="normal"><xsl:value-of select="locationCode" /></fo:block>
												</fo:table-cell>
												<fo:table-cell><fo:block></fo:block></fo:table-cell>
											</fo:table-row>
											</xsl:for-each>
											...
											<xsl:for-each select="./payment">
											<fo:table-row>
												<fo:table-cell border-color="#CC0000" border-bottom-width="0.5pt" border-bottom-style="solid"><fo:block></fo:block></fo:table-cell>
												<fo:table-cell border-color="#CC0000" border-bottom-width="0.5pt" border-bottom-style="solid" text-align="left" height="0.4cm">
													<fo:block font-family="Arial" font-size="9pt" font-weight="normal">Payment Type</fo:block>
												</fo:table-cell>
												<fo:table-cell border-color="#CC0000" border-bottom-width="0.5pt" border-bottom-style="solid" text-align="right" height="0.4cm">
					...
					<fo:block font-size="8pt" font-weight="bold" font-family="sans-serif" line-height="11pt" space-after.optimum="10pt" background-color="#A60000" color="white" text-align="left" padding-top="1pt">
					FLIGHT INFORMATION
					</fo:block>
									...
									<fo:block>
										<fo:table width="100%"  >
											...
											<fo:table-body>
												<fo:table-row>
													<fo:table-cell text-align="left">
														<fo:block font-family="Arial" font-size="9pt" font-weight="bold" background-color="#A60000" line-height="20pt">Travelers:</fo:block>
													</fo:table-cell>
													<fo:table-cell text-align="left">
														<fo:block font-family="Arial" font-size="9pt" font-weight="bold" background-color="#A60000" line-height="20pt">Status:</fo:block>
													</fo:table-cell>
													<fo:table-cell text-align="left">
												...
												<fo:table-body>
													<fo:table-row>
														<fo:table-cell text-align="center">
															<fo:block font-family="Arial" font-size="9pt" font-weight="bold" background-color="#A60000" line-height="20pt">Airline Confirmation #:</fo:block>
														</fo:table-cell>
													</fo:table-row>
													<fo:table-row>
														<fo:table-cell text-align="center">
															<fo:block font-family="Arial" font-size="12pt" font-weight="bold" background-color="White" line-height="20pt">
					...
					<fo:table width="100%"  >
							...
							<fo:table-body>
								<fo:table-row  background-color="#A60000">
									<fo:table-cell text-align="left">
								...
								<xsl:for-each select="./flights/flight">
										<!-- 	===============================   -->
										<xsl:variable name="varNormalBGColor">WhiteSmoke</xsl:variable>
										<xsl:variable name="varAccentBGColor">AliceBlue</xsl:variable>
										<!-- 	===============================   -->
										...
										<fo:table-row border-color="white" border-bottom-width="0.5pt" border-bottom-style="solid">
											...
											<xsl:attribute name="background-color">
											       <xsl:choose>
											         <xsl:when test="(position() mod 2) = 0"><xsl:value-of 
											...
											<fo:table-cell text-align="left">
												...
												<fo:block font-family="Arial" font-size="9pt" line-height="20pt">
																...
																Flt # <xsl:value-of select="number"/>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell text-align="left">
												<fo:block font-family="Arial" font-size="9pt" line-height="20pt">
					...
					<fo:block>
						<fo:table width="100%"  >
							...
							<fo:table-body>
								<fo:table-row>
									<fo:table-cell text-align="left" border-color="#CC0000" border-bottom-width="0.5pt" border-bottom-style="solid" border-top-width="0.5pt" border-top-style="solid">
										<fo:block font-family="Arial" font-size="12pt" line-height="14pt">
					...
					<fo:block page-break-before="always">
      					<fo:block font-size="10pt" font-weight="bold" font-family="sans-serif" line-height="15pt" space-after.optimum="10pt" background-color="#A60000" color="white" text-align="left" padding-top="1pt">
						...
						<fo:table width="100%"  >
							...
							<fo:table-body>
								<fo:table-row>
									<fo:table-cell text-align="left" border-color="#CC0000" border-top-width="0.5pt" border-top-style="solid">
										<fo:block font-family="Arial" font-size="9pt" line-height="10pt"></fo:block>
									</fo:table-cell>
									<fo:table-cell text-align="left" border-color="#CC0000" border-top-width="0.5pt" border-top-style="solid">
										<fo:block>&#160;</fo:block>
										<fo:block font-family="Arial" font-size="12pt" line-height="12pt" font-weight="bold">
											Fare Rules
										</fo:block>
									</fo:table-cell>
								</fo:table-row>
								...
								<fo:table-row>
									...
									<fo:table-cell text-align="left">
										<fo:block font-family="Arial" font-size="12pt" line-height="12pt">
...
urged to verify documentation requirements prior to purchasing airfare.
								...
								<fo:table-row>
									...
									<fo:table-cell text-align="left">
										<fo:block font-family="Arial" font-size="12pt" line-height="12pt" text-align="justify">
...
BOLETO, LA AGENCIA NO SE HACE RESPONSABLE POR NINGUN ERROR.
								...
								<fo:table-row>
									...
									<fo:table-cell text-align="left" border-color="#777777" border-top-width="0.5pt" border-top-style="solid">
										<fo:block line-height="20pt">&#160;</fo:block>
									</fo:table-cell>
								</fo:table-row>
								<fo:table-row>
...
reservations, and verify timing.
								...
								<fo:table-row>
									...
									<fo:table-cell text-align="left">
										<fo:block line-height="15pt">&#160;</fo:block>
										<fo:block font-family="Arial" font-size="12pt" line-height="12pt" font-weight="bold">
											Airline Check-In
										</fo:block>
										<fo:block font-family="Arial" font-size="12pt" line-height="12pt" text-align="justify">
...
in a given itinerary may or may not exist. Consult the airline(s) website, or phone directly to verify baggage details, if applicable.
						...
						<fo:table width="100%" border-color="#888888" border-top-width="1pt" border-top-style="solid" >
										<fo:table-column column-number="1" column-width="50%"/>
										<fo:table-column column-number="2" column-width="50%"/>
										<fo:table-body>
											<fo:table-row>
