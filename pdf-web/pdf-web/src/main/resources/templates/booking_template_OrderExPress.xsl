		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			...
			<fo:page-sequence master-reference="A4-portrait">
				<fo:flow flow-name="xsl-region-body">
			  		...
			  		<fo:table width="100%"  >
							...
							<fo:table-body>
								<fo:table-row>
									...
									<fo:table width="100%"  border-color="Wheat" border-bottom-width="1pt" border-bottom-style="solid">
										...
										<fo:table-body>
											<fo:table-row>
												<fo:table-cell>
													<fo:block>
														<fo:external-graphic src="url('pdfheader/OrderExpress.PNG')" content-height="scale-to-fit" height="0.8in"  content-width="1.5in" scaling="non-uniform"/>
													</fo:block>
												</fo:table-cell>
									...
									<fo:table-cell>
									<fo:block font-size="8pt" font-weight="bold" font-family="sans-serif" line-height="11pt" space-after.optimum="2pt" background-color="#00006E" color="white" text-align="left" padding-top="1pt">
										PRO-FORMA INVOICE
									</fo:block>
					...
					<fo:block font-size="8pt" font-weight="bold" font-family="sans-serif" line-height="11pt" space-after.optimum="10pt" background-color="#00006E" color="white" text-align="left" padding-top="1pt">
					FLIGHT INFORMATION
					</fo:block>
									...
									<fo:block>
										<fo:table width="100%"  >
											...
											<fo:table-body>
												<fo:table-row>
													<fo:table-cell text-align="left">
														<fo:block font-family="Arial" font-size="9pt" font-weight="bold" background-color="#E86C19" line-height="20pt">Travelers:</fo:block>
													</fo:table-cell>
													<fo:table-cell text-align="left">
														<fo:block font-family="Arial" font-size="9pt" font-weight="bold" background-color="#E86C19" line-height="20pt">Status:</fo:block>
													</fo:table-cell>
													<fo:table-cell text-align="left">
												...
												<fo:table-body>
													<fo:table-row>
														<fo:table-cell text-align="center">
															<fo:block font-family="Arial" font-size="9pt" font-weight="bold" background-color="#E86C19" line-height="20pt">Airline Confirmation #:</fo:block>
														</fo:table-cell>
													</fo:table-row>
													<fo:table-row>
														<fo:table-cell text-align="center">
					...
					<fo:table width="100%"  >
							...
							<fo:table-body>
								<fo:table-row  background-color="#E86C19">
									<fo:table-cell text-align="left">
					...
					<fo:block page-break-before="always">
      					<fo:block font-size="10pt" font-weight="bold" font-family="sans-serif" line-height="15pt" space-after.optimum="10pt" background-color="#00006E" color="white" text-align="left" padding-top="1pt">
