		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			...
			<fo:page-sequence master-reference="A4-portrait">
				<fo:flow flow-name="xsl-region-body">
			  		...
			  		<fo:table width="100%"  >
							...
							<fo:table-body>
								<fo:table-row>
									<fo:table-cell>
									<fo:block>
									<fo:table width="100%"  border-color="#343434" border-bottom-width="1pt" border-bottom-style="solid">
										...
										<fo:table-body>
											<fo:table-row>
												<fo:table-cell>
													<fo:block>
														<fo:external-graphic src="url('pdfheader/UNBank.PNG')" content-height="scale-to-fit" height="0.75in"  content-width="1in" scaling="non-uniform"/>
													</fo:block>
												</fo:table-cell>
									...
									<fo:block font-size="10pt" font-weight="bold" font-family="sans-serif" color="#343434">
									</fo:block>
									</fo:table-cell>
									<fo:table-cell>
									<fo:block font-size="8pt" font-weight="bold" font-family="sans-serif" line-height="11pt" space-after.optimum="2pt" background-color="#2B2B25" color="white" text-align="left" padding-top="1pt">
										PRO-FORMA INVOICE
									</fo:block>
									<fo:block background-color="WhiteSmoke">
										...
										<fo:table-body>
											<fo:table-row>
												<fo:table-cell height="0.5cm" border-color="#383838" border-bottom-width="0.5pt" border-bottom-style="solid"><fo:block></fo:block></fo:table-cell>
												<fo:table-cell height="0.5cm" border-color="#383838" border-bottom-width="0.5pt" border-bottom-style="solid"><fo:block></fo:block></fo:table-cell>
												<fo:table-cell height="0.5cm" border-color="#383838" border-bottom-width="0.5pt" border-bottom-style="solid"><fo:block></fo:block></fo:table-cell>
												<fo:table-cell height="0.5cm" border-color="#383838" border-bottom-width="0.5pt" border-bottom-style="solid"><fo:block></fo:block></fo:table-cell>
											</fo:table-row>
					...
					<fo:block font-size="8pt" font-weight="bold" font-family="sans-serif" line-height="11pt" space-after.optimum="10pt" background-color="#2B2B25" color="white" text-align="left" padding-top="1pt">
					FLIGHT INFORMATION
					</fo:block>
									...
									<fo:block>
										<fo:table width="100%"  >
											...
											<fo:table-body>
												<fo:table-row>
													<fo:table-cell text-align="left">
														<fo:block font-family="Arial" font-size="9pt" font-weight="bold" background-color="#828282" line-height="20pt">Travelers:</fo:block>
													</fo:table-cell>
													<fo:table-cell text-align="left">
														<fo:block font-family="Arial" font-size="9pt" font-weight="bold" background-color="#828282" line-height="20pt">Status:</fo:block>
													</fo:table-cell>
													<fo:table-cell text-align="left">
												...
												<fo:table-body>
													<fo:table-row>
														<fo:table-cell text-align="center">
															<fo:block font-family="Arial" font-size="9pt" font-weight="bold" background-color="#828282" line-height="20pt">Airline Confirmation #:</fo:block>
														</fo:table-cell>
													</fo:table-row>
													<fo:table-row>
														<fo:table-cell text-align="center">
					...
					<fo:table width="100%"  >
							...
							<fo:table-body>
								<fo:table-row  background-color="#828282">
									<fo:table-cell text-align="left">
					...
					<fo:block>
						<fo:table width="100%"  >
							...
							<fo:table-body>
								<fo:table-row>
									<fo:table-cell text-align="left" border-color="#3E3E3E" border-bottom-width="0.5pt" border-bottom-style="solid" border-top-width="0.5pt" border-top-style="solid">
					...
					<fo:block page-break-before="always">
      					<fo:block font-size="10pt" font-weight="bold" font-family="sans-serif" line-height="15pt" space-after.optimum="10pt" background-color="#2B2B25" color="white" text-align="left" padding-top="1pt">
						...
						<fo:table width="100%"  >
							...
							<fo:table-body>
								<fo:table-row>
									<fo:table-cell text-align="left" border-color="452XJT" border-top-width="0.5pt" border-top-style="solid">
										<fo:block font-family="Arial" font-size="9pt" line-height="10pt"></fo:block>
									</fo:table-cell>
									<fo:table-cell text-align="left" border-color="#535353" border-top-width="0.5pt" border-top-style="solid">
										<fo:block>&#160;</fo:block>
...
BOLETO, LA AGENCIA NO SE HACE RESPONSABLE POR NINGUN ERROR.
								...
								<fo:table-row>
									...
									<fo:table-cell text-align="left" border-color="#383838" border-top-width="0.5pt" border-top-style="solid">
										<fo:block line-height="20pt">&#160;</fo:block>
									</fo:table-cell>
								</fo:table-row>
								<fo:table-row>
...
in a given itinerary may or may not exist. Consult the airline(s) website, or phone directly to verify baggage details, if applicable.
						...
						<fo:table width="100%" border-color="#5D5D5D" border-top-width="1pt" border-top-style="solid" >
										<fo:table-column column-number="1" column-width="50%"/>
										<fo:table-column column-number="2" column-width="50%"/>
										<fo:table-body>
											<fo:table-row>
