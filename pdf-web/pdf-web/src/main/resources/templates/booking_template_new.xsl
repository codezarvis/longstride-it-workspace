		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			...
			<fo:page-sequence master-reference="A4-portrait">
				<fo:flow flow-name="xsl-region-body">
												...
												<fo:table-row>
													...
													<fo:table-cell text-align="left" height="1.5cm" display-align="after"> <!--  -->
														...
														<xsl:for-each select="./payment">
															<fo:block font-family="Arial" font-size="10pt" font-weight="normal">
															<xsl:value-of select="cardHolderAddress"/> 
															</fo:block>
														</xsl:for-each>
													</fo:table-cell>
												</fo:table-row>
										...
										<fo:table-body>
											...
											<fo:table-row>
												...
												<fo:table-cell border-color="brown" border-bottom-width="0.5pt" border-bottom-style="solid" text-align="right" height="0.4cm">
													<fo:block font-family="Arial" font-size="9pt" font-weight="normal"><xsl:value-of select="creditCardNo" /></fo:block>
												</fo:table-cell>
												<fo:table-cell border-color="brown" border-bottom-width="0.5pt" border-bottom-style="solid"><fo:block></fo:block></fo:table-cell>
											</fo:table-row>
											</xsl:for-each>
					...
					<fo:block page-break-before="always">  <!-- page-break-inside="avoid"  -->
      					<fo:block font-size="12pt" font-weight="bold" font-family="sans-serif" line-height="12pt" space-after.optimum="10pt" background-color="brown" color="white" text-align="left" padding-top="1pt">
