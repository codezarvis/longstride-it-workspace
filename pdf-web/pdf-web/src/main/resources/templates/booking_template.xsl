			...
			<fo:page-sequence master-reference="A4-portrait">
				<fo:flow flow-name="xsl-region-body">
					...
					<fo:block page-break-before="always">
      					<fo:block font-size="10pt" font-weight="bold" font-family="sans-serif" line-height="15pt" space-after.optimum="10pt" background-color="brown" color="white" text-align="left" padding-top="1pt">
