		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			...
			<fo:page-sequence master-reference="A4-portrait">
				<fo:flow flow-name="xsl-region-body">
			  		...
			  		<fo:table width="100%"  >
							...
							<fo:table-body>
								<fo:table-row>
									<fo:table-cell>
									<fo:block>
									<fo:table width="100%"  border-color="#888888" border-bottom-width="1pt" border-bottom-style="solid">
										...
										<fo:table-body>
											<fo:table-row>
												<fo:table-cell>
													<fo:block>
														<fo:external-graphic src="url('pdfheader/Sigue.PNG')" content-height="scale-to-fit" height="0.75in"  content-width="1.3in" scaling="non-uniform"/>
													</fo:block>
												</fo:table-cell>
									...
									<fo:table-cell>
									<fo:block font-size="8pt" font-weight="bold" font-family="sans-serif" line-height="11pt" space-after.optimum="2pt" background-color="#197519" color="white" text-align="left" padding-top="1pt">
										PRO-FORMA INVOICE
									</fo:block>
									<fo:block background-color="WhiteSmoke">
										...
										<fo:table-body>
											<fo:table-row>
												<fo:table-cell height="0.5cm" border-color="#2D9E2D" border-bottom-width="0.5pt" border-bottom-style="solid"><fo:block></fo:block></fo:table-cell>
												<fo:table-cell height="0.5cm" border-color="#2D9E2D" border-bottom-width="0.5pt" border-bottom-style="solid"><fo:block></fo:block></fo:table-cell>
												<fo:table-cell height="0.5cm" border-color="#2D9E2D" border-bottom-width="0.5pt" border-bottom-style="solid"><fo:block></fo:block></fo:table-cell>
												<fo:table-cell height="0.5cm" border-color="#2D9E2D" border-bottom-width="0.5pt" border-bottom-style="solid"><fo:block></fo:block></fo:table-cell>
											</fo:table-row>
											...
											<xsl:for-each select="./payment">
											<fo:table-row>
												<fo:table-cell border-color="#2D9E2D" border-bottom-width="0.5pt" border-bottom-style="solid"><fo:block></fo:block></fo:table-cell>
												<fo:table-cell border-color="#2D9E2D" border-bottom-width="0.5pt" border-bottom-style="solid" text-align="left" height="0.4cm">
													<fo:block font-family="Arial" font-size="9pt" font-weight="normal">Payment Type</fo:block>
												</fo:table-cell>
												<fo:table-cell border-color="#2D9E2D" border-bottom-width="0.5pt" border-bottom-style="solid" text-align="right" height="0.4cm">
					...
					<fo:block font-size="8pt" font-weight="bold" font-family="sans-serif" line-height="11pt" space-after.optimum="10pt" background-color="#197519" color="white" text-align="left" padding-top="1pt">
					FLIGHT INFORMATION
					</fo:block>
									...
									<fo:block>
										<fo:table width="100%"  >
											...
											<fo:table-body>
												<fo:table-row>
													<fo:table-cell text-align="left">
														<fo:block font-family="Arial" font-size="9pt" font-weight="bold" background-color="#CF2900" line-height="20pt">Travelers:</fo:block>
													</fo:table-cell>
													<fo:table-cell text-align="left">
														<fo:block font-family="Arial" font-size="9pt" font-weight="bold" background-color="#CF2900" line-height="20pt">Status:</fo:block>
													</fo:table-cell>
													<fo:table-cell text-align="left">
												...
												<fo:table-body>
													<fo:table-row>
														<fo:table-cell text-align="center">
															<fo:block font-family="Arial" font-size="9pt" font-weight="bold" background-color="#CF2900" line-height="20pt">Airline Confirmation #:</fo:block>
														</fo:table-cell>
													</fo:table-row>
													<fo:table-row>
														<fo:table-cell text-align="center">
					...
					<fo:table width="100%"  >
							...
							<fo:table-body>
								<fo:table-row  background-color="#CF2900">
									<fo:table-cell text-align="left">
					...
					<fo:block>
						<fo:table width="100%"  >
							...
							<fo:table-body>
								<fo:table-row>
									<fo:table-cell text-align="left" border-color="#197519" border-bottom-width="0.5pt" border-bottom-style="solid" border-top-width="0.5pt" border-top-style="solid">
					...
					<fo:block page-break-before="always">
      					<fo:block font-size="10pt" font-weight="bold" font-family="sans-serif" line-height="15pt" space-after.optimum="10pt" background-color="#197519" color="white" text-align="left" padding-top="1pt">
						...
						<fo:table width="100%"  >
							...
							<fo:table-body>
								<fo:table-row>
									<fo:table-cell text-align="left" border-color="#197519" border-top-width="0.5pt" border-top-style="solid">
...
BOLETO, LA AGENCIA NO SE HACE RESPONSABLE POR NINGUN ERROR.
								...
								<fo:table-row>
									...
									<fo:table-cell text-align="left" border-color="#888888" border-top-width="0.5pt" border-top-style="solid">
										<fo:block line-height="20pt">&#160;</fo:block>
									</fo:table-cell>
								</fo:table-row>
								<fo:table-row>
