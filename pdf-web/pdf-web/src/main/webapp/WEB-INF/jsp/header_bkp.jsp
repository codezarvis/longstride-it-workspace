...
<!--  -->
<%if(request.getSession(false).getAttribute("companyId").toString().equals("45243")) {%>
	<div id="image" style="display:inline;">
        <img src="../images/casa_logo.png" height="90px" width="90px"/>
    </div>
    <div id="texts" style="display:inline; white-space:nowrap; color: brown;font-size: 40; font-weight: bold;"> 
       Casa Travel
    </div>
<%} if(request.getSession(false).getAttribute("companyId").toString().equals("86705")) {%>
	<div id="image" style="display:inline;">
        <img src="../images/mg_logo.png" height="95px" width="300px"/>
    </div>
    
<%} if(request.getSession(false).getAttribute("companyId").toString().equals("98389")) {%>
<div id="image" style="display:inline;">
        <img src="../images/barri_logo.png" height="95px" width="300px"/>
    </div>
    
<%} if(request.getSession(false).getAttribute("companyId").toString().equals("98897")) {%>
<div id="image" style="display:inline;">
        <img src="../images/pom_logo.jpg" height="106px" width="189px"/>
    </div>
    
<%}  if(request.getSession(false).getAttribute("companyId").toString().equals("86933")) {%>
<div id="image" style="display:inline;">
        <img src="../images/order_logo.png" height="85px" width="350px"/>
    </div>
    
<%} if(request.getSession(false).getAttribute("companyId").toString().equals("96720")) {%>
<div id="image" style="display:inline;">
        <img src="../images/unbank_logo.jpg" height="95px" width="120px"/>
    </div>
    
<%} if(request.getSession(false).getAttribute("companyId").toString().equals("99621")) {%>
<div id="image" style="display:inline;">
        <img src="../images/logo_micro_manos.png" height="90px" width="300px"/>
    </div>
    
<%} if(request.getSession(false).getAttribute("companyId").toString().equals("54321")) {%>
<div id="image" style="display:inline;">
        <img src="../images/siguecorp_logo.png" height="95px" width="120px"/>
    </div>
<%} %>
</td>
<td align="left" width="30%">
<div style="display:inline; text-align: left; color: #8A2BE2;font-size: 25; font-weight: bold">Welcome  <%=request.getSession(false).getAttribute("username")%> </div>
</td>
