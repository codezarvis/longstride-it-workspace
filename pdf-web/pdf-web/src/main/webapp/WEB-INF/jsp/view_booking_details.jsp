...
<head>
  ...
  $(document).ready(function() {
	  ...
	  $('#example').DataTable({
	    	"ajax": '../jersey/accounts/financedata',
	    	"sDom": 'T<"clear">lfrtip',
	    	"fnFooterCallback": function ( nRow, aaData, iStart, iEnd, aiDisplay ) {
	    		var iTotalMarket = 0.0;
	    		var cAmt = 0.0;
	    		var acAmt = 0.0;
	            ...
	            $('#ccComm').val('$'+((iTotalMarket*1).toFixed(2)));
	            $('#achAmt').val('$'+((acAmt*1).toFixed(2)));
	            $('#ccAmt').val('$'+((cAmt*1).toFixed(2)));
	    	},
			"oTableTools": {
  ...
  $(function(){
	  ...
	  $("#financeBtn").click(function() {
			...
			if(isValid) {
				...
				var url="../jersey/accounts/financedata?pnr="+pnr+"&startDt="+startDt+"&endDt="+endDt;
				if ( $.fn.dataTable.isDataTable( '#example' ) ) {
				    table = $('#example').DataTable();
				    table.destroy();
				}
...
<div id="rtabs">
  <ul>
    ...
    <li><a href="#ivinUi">Financials</a></li>
  </ul>


	<div class="container" id="ivinUi" style="height: auto;">
	
	 <!-- <table align="center" border="2" cellpadding="30" bgcolor="white">
            <td><b>Welcome : ANALINE GUADARRAMA</b></td>
        </table> -->

       <!--  <table align="center" width="75%" cellpadding="5" bgcolor="white" >

            <tr >
                <td bgcolor="green"><b>Reports</b></td>
            </tr>
        </table>-->
         <table>
            <tr>
                <td>PNR</td>
                <td><input type="text" size="10" id="pnr"/></td>
                <td>Start Date</td>
                <td><input type="text" size="10" id="startDate"/>&nbsp;&nbsp;<img src="../images/cal.png" id="startIco"/></td>
                <td>End Date</td>
                <td><input type="text" size="10" value="" id="endDate"/>&nbsp;&nbsp;<img src="../images/cal.png" id="endIco"/></td>
                <td><input id="financeBtn" type="button" value="Retrieve Report" /></td>
                <td><button>Export Report</button></td>
            </tr>
            <tr>                
            </tr>
            <tr>
            ...
            <tr>
                <td>Ach Amt:</td>
                <td><input type="text" id="achAmt" name="achAmt" value="$0.0" style="text-align: right;" disabled/></td>
                <td>CC Amt:</td>
                <td><input type="text" id="ccAmt" name="ccAmt" style="text-align: right;" value="$0.0" disabled/></td>
                <td>CC Comm:</td>
                <td><input type="text" id="ccComm" name="ccComm" value="$0.0" style="text-align: right;" disabled/></td>
