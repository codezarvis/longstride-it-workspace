...
<script src="../js/tips-global.js" type="text/javascript"></script>
  ...
  $(document).ready(function() {
	  ...
	  //http://editor.datatables.net/examples/advanced/upload.html
	  //https://datatables.net/forums/discussion/29416/file-upload-example
	  //http://www.datatables.net/forums/discussion/29054/is-there-a-way-to-programmatically-change-the-editor-lightbox-height
	  ...
	  storeEditor = new $.fn.dataTable.Editor( {
	        ...
	        i18n: {
	            ...
	            remove: {
	                confirm: {
	                    _: "Are you sure you wish to delete %d Stores?",
	                    1: "Are you sure you wish to delete 1 Store?"
	                }
	            },
	            error: {
	  ...
	  storeEditor.on('onInitEdit onInitCreate', function () {
		  storeEditor.field('affiliateId').update(getAllAffiliates());
