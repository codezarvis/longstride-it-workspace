this.OFramework = new function () {
    ...
    //this.BaseURI = src.indexOf("searchforms/oframework.js") > -1 ? src.replace("searchforms/oframework.js", "") : "../";
   // this.BaseURI = tag.src.search(/searchforms\/oframework.js/i) > -1 ? tag.src.replace(/searchforms\/oframework.js/gi, "") : tag.src.search(/searchforms\/oframework.min.js/i) > -1 ? tag.src.replace(/searchforms\/oframework.min.js/gi, ""):"../";
   this.BaseURI = 'http://air.casatravel.com/web/';
		...
		this.FieldInfo = function (oContainer){
			...
			o.onclick = function (e){
				if (OFramework.ActiveElement != null) OFramework.ActiveElement.Blur();
				 ...
				 this.className = "fieldinfo focus pax-count-dd";
    ...
    this.AirSearchForm = function (oContainer) {
       ...
       // oContainer.Target = document.getElementById("res");
        ...
        oContainer.AdvancedSearch = function () {
           ...
           // window.open("http://localhost:8080/casa-booking-tracker/sample.htm");
            document.getElementById("res").style.display = "block";
            document.getElementById("showLink").style.display = "block";
            document.getElementById("res").src = sStr;
            document.getElementById("backRes").value = sStr;
        }
        oContainer.SubmitSearch = function () {
            ...
            sStr += "&" + segmentData;
            //console.debug(sStr+' <br/>'+this.Target);
            //res = sStr;
            //document.getElementById("res").src = sStr;
           //window.open("http://localhost:8080/casa-booking-tracker/sample.htm","_self");
          // console.debug('-----'+document.getElementById("res"));
            document.getElementById("res").style.display = "block";
            document.getElementById("showLink").style.display = "block";
           document.getElementById("res").src = sStr;
           document.getElementById("backRes").value = sStr;
    ...
    this.CruiseSearchForm = function (oContainer, flt) {
        ...
        oContainer.innerHTML = "loading...";
        oContainer.Target = "_top";
        //oContainer.Target = document.getElementById("myRes");
        oContainer.TargetURL = null;
